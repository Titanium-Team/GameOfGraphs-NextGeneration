...
public class Edge{
  ...
  */
  @JsonCreator
  public Edge(@JsonProperty("verticesId") String[] verticesId, @JsonProperty("weight") double pWeight){
  ...
  */
  public Vertex[] getVerticesId(Graph graph){
    Vertex[] result = new Vertex[2];
    result[0] = graph.getVertex(verticesId[0]);
    result[1] = graph.getVertex(verticesId[1]);
    return result;
  }
