 ...
 * </p>
 * <p>
 * Generische Klasse graph.List<ContentType>
 * </p>
 * <p>
 * Objekt der generischen Klasse graph.List verwalten beliebig viele linear
...
public class List<ContentType> {
    ...
    private class ListNode {
         ...
         */
        private ListNode(@JsonProperty("current") ContentType pContent) {
  ...
  /* ----------- Ende der privaten inneren Klasse -------------- */
    ...
    public Vertex getNext(){
        try {
            return (Vertex) current.getNextNode().getContentObject();
    ...
    public void append(@JsonProperty("next") ContentType pContent) {
     ...
     *
     * @param pList
     *            die am Ende anzuhaengende Liste vom Typ graph.List<ContentType>
     */
